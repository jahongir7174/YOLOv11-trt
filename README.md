...
YOLOv11-trt is an advanced, high-performance object detection framework based on the YOLOv11 architecture, optimized for
NVIDIA TensorRT. It supports ONNX export, TensorRT engine building, and fast inference on GPU, making it suitable for
...
Ensure you have [NVIDIA Docker](https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/install-guide.html)
and a compatible GPU driver installed.
